...
function toggleBlink() {
    $('#alert').toggleClass('blink');
}

// Start the blinking effect using setInterval
setInterval(toggleBlink, 1000); // Toggle every 1000 milliseconds (1 second)
...
function hideElements() {
    ...
    var elementsToHide = document.querySelectorAll('.hide-on-dev');
...
// Call the function to hide elements when the page loads
